...
namespace IO.Swagger.Controllers
{
    ...
    public class AASXFileServerAPIApiController : ControllerBase
    {
        ...
        public AASXFileServerAPIApiController(IAppLogger<AASXFileServerAPIApiController> logger, IBase64UrlDecoderService decoderService, IAasxFileServerInterfaceService fileService, IPaginationService paginationService)
        {
