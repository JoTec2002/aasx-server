...
namespace IO.Swagger.Controllers
{
    ...
    public class AssetAdministrationShellRepositoryAPIApiController : ControllerBase
    {
        ...
        [SwaggerResponse(statusCode: 500, type: typeof(Result), description: "Internal Server Error")]
        [SwaggerResponse(statusCode: 0, type: typeof(Result), description: "Default error handling for unmentioned status codes")]
        //TODO (???, 0000-00-00): assetIds: string or specific asset id, and what about Base64Uel encoding
        ...
        [SwaggerResponse(statusCode: 500, type: typeof(Result), description: "Internal Server Error")]
        [SwaggerResponse(statusCode: 0, type: typeof(Result), description: "Default error handling for unmentioned status codes")]
        //TODO (jtikekar, 0000-00-00): assetIds: string or specific asset id, and what about Base64Uel encoding
        ...
        public virtual IActionResult GetAllSubmodelElementsReferenceAasRepository([FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromQuery] int? limit, [FromQuery] string cursor, [FromQuery] LevelEnum level)
        {
            ...
            //TODO (jtikekar, 0000-00-00): check performace imapct due to ConvertAll
            var smePaginated = _paginationService.GetPaginatedList(smeList, new PaginationParameters(cursor, limit));
        ...
        public virtual IActionResult GetOperationAsyncResultAasRepository([FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromRoute][Required] string idShortPath, [FromRoute][Required] string handleId)
        {
            ...
            //TODO (jtikekar, 0000-00-00): Uncomment the next line to return response 400 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(400, default(Result));

            //TODO (jtikekar, 0000-00-00): Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Result));

            //TODO (jtikekar, 0000-00-00): Uncomment the next line to return response 403 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(403, default(Result));

            //TODO (jtikekar, 0000-00-00): Uncomment the next line to return response 404 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(404, default(Result));

            //TODO (jtikekar, 0000-00-00): Uncomment the next line to return response 500 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(500, default(Result));

            //TODO (jtikekar, 0000-00-00): Uncomment the next line to return response 0 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            ...
            : default(OperationResult);            //TODO (jtikekar, 0000-00-00): Change the data returned
        ...
        public virtual IActionResult GetOperationAsyncStatusAasRepository([FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromRoute][Required] string idShortPath, [FromRoute][Required] string handleId)
        {
            ...
            //TODO (???, 0000-00-00): Uncomment the next line to return response 302 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            ...
            //TODO (???, 0000-00-00): Uncomment the next line to return response 401 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
            // return StatusCode(401, default(Result));
            ...
            : default(BaseOperationResult);            //TODO (???, 0000-00-00): Change the data returned
            return new ObjectResult(example);
        }
        ...
        public virtual IActionResult GetSubmodelElementByPathReferenceAasRepository([FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromRoute][Required] string idShortPath, [FromQuery] LevelEnum level)
        {
            ...
            //TODO (jtikekar, 0000-00-00): Level should not be applicable
        ...
        public virtual IActionResult InvokeOperationAasRepository([FromBody] OperationRequest body, [FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromRoute][Required] string idShortPath)
        {
            ...
            var example = exampleJson != null
            ? JsonConvert.DeserializeObject<OperationResult>(exampleJson)
            : default(OperationResult);            //TODO (???, 0000-00-00): Change the data returned
            return new ObjectResult(example);
        }
        ...
        {
            //TODO (???, 0000-00-00): Uncomment the next line to return response 202 or use other options such as return this.NotFound(), return this.BadRequest(..), ...
        ...
        public virtual IActionResult InvokeOperationValueOnlyAasRepository([FromBody] object body, [FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromRoute][Required] string idShortPath)
        {
            ...
            : default(object);            //TODO (???, 0000-00-00): Change the data returned
            return new ObjectResult(example);
        }
        ...
        public virtual IActionResult PatchSubmodelByIdValueOnlyAasRepository([FromBody] SubmodelValue body, [FromRoute][Required] string aasIdentifier, [FromRoute][Required] string submodelIdentifier, [FromQuery] LevelEnum level)
        {
            ...
            //TODO (jtikekar, 0000-00-00): applay level modifier
